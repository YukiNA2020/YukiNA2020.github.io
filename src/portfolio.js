...
const socialMediaLinks = {
  ...
  // Add other social media links if you have them
...
const educationInfo = {
  ...
  schools: [
    ...
    {
      schoolName: "Southwestern University of Finance and Economics",
      subHeader: "Bachelor of Science in Information Management and Information Systems",
      duration: "September 2021 - June 2025",
      desc: "Undergraduate program in information management and systems.",
      descBullets: []
    },
    {
      schoolName: "London School of Economics and Political Science",
      subHeader: "Exchange Program - Marketing",
      duration: "July 2023 - August 2023",
      desc: "Summer exchange program focusing on marketing studies.",
      descBullets: []
    }
  ]
};
...
const githubProfile = {
  showGithubProfile: "false", // Set "true" to display GitHub profile instead of simple contact form
  display: true
};
